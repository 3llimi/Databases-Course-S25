...
SELECT artist_id, name FROM Albums WHERE year_of_publication >= 2001;
SELECT Albums.name AS album_name, Artists.name AS artist_name FROM Albums JOIN Artists ON Albums.artist_id = Artists.id;